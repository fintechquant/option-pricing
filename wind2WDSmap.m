function result = wind2WDSmap()
x = {
%    FactorLab_zyd
    'wQtr.Stm_IssuingDate'                                  'AShareIncome.ANN_DT';                    % num2date();
    'wQtr.Stm_PublishDate'                                  'Stm_PublishDate';
...
%    Pricing info
    ...
    'wPrc_Stocks.Industry_Citic'                            'AIndexMembersCITICS.S_INFO_WINDCODE';  % S_CON_INDATE
    'wPrc_Indices.Close'                                    'AIndexEODPrices.S_DQ_CLOSE';
    'wPrc_Indices.Close'                                    'AIndexIndustriesEODCITICS.S_DQ_CLOSE';
    'wIdx.CSI800'                                           'AIndexMembers.CSI800'
};
    result = containers.Map(x(:,1),x(:,2));
end
